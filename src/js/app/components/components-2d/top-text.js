...
export default class TopText extends DisplayObject {
  constructor() {
    ...
    this.visible = ConfigurableParams.getData()["top_text"]["top_title_enabled"]["value"];
  }
  ...
  onAdded() {
    ...
    this._textContainer.y = this._height / 2 + 5;
  ...
  _resizeBg() {
    ...
    this._bg.rect(0, -100, bb.width + Helpers.LP(200, 0), this._height + 100);
    this._bg.fill();
  }
